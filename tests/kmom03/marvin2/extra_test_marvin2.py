...
class Test3Marvin2Extra(ExamTestCase):
    ...
    link_to_assignment = (
        "https://dbwebb.se/uppgift/din-egen-chattbot-marvin-steg-2-v4#extra"
    )
    ...
    def test_has_strings_func(self):
        ...
        self.assertEqual(marvin2.has_strings(*self._multi_arguments), "No match")
    ...
    def test_create_ssn_ext_func(self):
        ...
        self.assertFalse(
            int(ssn[-2]) % 2 == 0,
            [f"Förväntar att tredje siffran i {ssn} är udda", "Den var jämn"],
        )
        self.assertFalse(
    ...
    def test_find_all_indexes_menu(self):
        ...
        self.check_print_contain(self._multi_arguments, ["27,36,99"], main.main)
    ...
    def test_find_all_indexes_includes_last(self):
        ...
        self.assertEqual(
            marvin2.find_all_indexes(*self._multi_arguments), "60,85,86,87,107"
        )
    ...
    def test_find_all_indexes_missing(self):
        ...
        self.assertEqual(marvin2.find_all_indexes(*self._multi_arguments), "")
